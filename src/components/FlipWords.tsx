...
function FlipWords({
  ...
  const isHighlighted = highlightWord != null && currentWord === highlightWord;
    ...
    <span data-slot="flip-words" {...props}>
      ...
      >
        <motion.span
          ...
          className={cn(
            "relative inline-block whitespace-nowrap px-1 text-left will-change-transform will-change-opacity will-change-filter",
            isHighlighted ? highlightClassName : className
          )}
          exit={{
            opacity: 0,
            y: -40,
