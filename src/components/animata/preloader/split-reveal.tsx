...
function SplitRevealRoot({
  ...
  useEffect(() => {
    ...
    const clearTimers = () => {
      if (fadeTimer !== undefined) { window.clearTimeout(fadeTimer); fadeTimer = undefined; }
      if (revealTimer !== undefined) { window.clearTimeout(revealTimer); revealTimer = undefined; }
      if (doneTimer !== undefined) { window.clearTimeout(doneTimer); doneTimer = undefined; }
    };
